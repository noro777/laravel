    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-1">
                        <a href="{{route('post.create')}}" class="btn btn-block btn-primary">Add</a>
                    </div>
                    ...
                    @foreach($data as $datas)
                            ...
                            <tr class="odd">
                                ...
                                <td>{{$datas->title}}</td>
                                <td>
                                    <a href="{{route('post.show',$datas->id)}}"><i class="fas fa-eye"></i></a>
                                    <a href="{{route('post.edit',$datas->id)}}"><i class="fas fa-pen"></i></a>
                                    <form action="{{route('post.delete',$datas->id)}}" method="post">
                                        @csrf
                                        @method('delete')
                                        <button>
